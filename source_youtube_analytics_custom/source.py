...
class SourceYoutubeAnalyticsCustom(AbstractSource):
    @staticmethod
    ...
    def streams(self, config: Mapping[str, Any]) -> List[Stream]:
        ...
        channel_reports = json.loads(pkgutil.get_data("source_youtube_analytics_custom", "defaults/channel_reports.json"))

        streams = []

        for channel_report in channel_reports:
            # print("check here",channel_report)
